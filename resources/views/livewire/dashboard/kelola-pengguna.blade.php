                ...
                <div class="flex flex-col gap-y-4">
                    ...
                    <div class="min-lg:grid min-lg:grid-cols-14 w-full gap-x-2 max-lg:flex max-lg:flex-row max-lg:flex-wrap max-lg:gap-y-4 max-lg:pb-4">
                        ...
                        <div class="min-lg:col-span-3 flex flex-row relative items-center">
                            <input placeholder="Nama Pengguna" class=" ps-8 min-lg:w-full rounded-full items-center text-left bg-dark/40 p-2 px-4 placeholder:text-black/60 placeholder:font-italic border-2 border-dark/40" />
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" class="w-4 h-4 fill-black/40 absolute left-2"><path d="M480 272C480 317.9 465.1 360.3 440 394.7L566.6 521.4C579.1 533.9 579.1 554.2 566.6 566.7C554.1 579.2 533.8 579.2 521.3 566.7L394.7 440C360.3 465.1 317.9 480 272 480C157.1 480 64 386.9 64 272C64 157.1 157.1 64 272 64C386.9 64 480 157.1 480 272zM272 416C351.5 416 416 351.5 416 272C416 192.5 351.5 128 272 128C192.5 128 128 192.5 128 272C128 351.5 192.5 416 272 416z"/></svg>
                        </div>
                        ...
                        <div class="min-lg:col-span-2 flex flex-row relative items-center">
                            <input placeholder="Jumlah Penumpang" class="ps-8 min-lg:w-full rounded-full items-center text-left bg-dark/40 p-2 px-4 placeholder:text-black/60 placeholder:font-italic border-2 border-dark/40" />
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" class="w-4 h-4 fill-black/40 absolute left-2"><path d="M480 272C480 317.9 465.1 360.3 440 394.7L566.6 521.4C579.1 533.9 579.1 554.2 566.6 566.7C554.1 579.2 533.8 579.2 521.3 566.7L394.7 440C360.3 465.1 317.9 480 272 480C157.1 480 64 386.9 64 272C64 157.1 157.1 64 272 64C386.9 64 480 157.1 480 272zM272 416C351.5 416 416 351.5 416 272C416 192.5 351.5 128 272 128C192.5 128 128 192.5 128 272C128 351.5 192.5 416 272 416z"/></svg>
                        </div>
                        <div class="min-lg:col-span-2 flex flex-row relative items-center">
                            <input placeholder="Jenis Kendaraan" class="ps-8 min-lg:w-full rounded-full items-center text-left bg-dark/40 p-2 px-4 placeholder:text-black/60 placeholder:font-italic border-2 border-dark/40" />
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" class="w-4 h-4 fill-black/40 absolute left-2"><path d="M480 272C480 317.9 465.1 360.3 440 394.7L566.6 521.4C579.1 533.9 579.1 554.2 566.6 566.7C554.1 579.2 533.8 579.2 521.3 566.7L394.7 440C360.3 465.1 317.9 480 272 480C157.1 480 64 386.9 64 272C64 157.1 157.1 64 272 64C386.9 64 480 157.1 480 272zM272 416C351.5 416 416 351.5 416 272C416 192.5 351.5 128 272 128C192.5 128 128 192.5 128 272C128 351.5 192.5 416 272 416z"/></svg>
                        </div>
                        <div class="min-lg:col-span-2 flex flex-row relative items-center">
                    ...
                    <table class="bg-yellow rounded-2xl border-2 border-dark p-4 flex flex-col gap-y-4 max-lg:hidden ">
                        ...
                        <tbody class="bg-orange flex flex-col rounded-2xl border-2 border-dark">
                            ...
                            <tr class="grid grid-cols-14 items-center border-b-2 border-dark">
                                ...
                                <td class="col-span-3 h-full flex justify-center items-center text-center p-2 text-white font-bold border-e-2 border-dark">Achul</td>
                                <td class="col-span-3 h-full flex justify-center items-center text-center p-2 text-white font-bold border-e-2 border-dark">Batam - Bintan</td>
                                ...
                                <td class="col-span-2 h-full flex justify-center items-center text-center p-2 text-white font-bold border-e-2 border-dark">Menunggu Verifikasi</td>
                                <td class="col-span-2 h-full flex justify-center items-center text-center p-2 text-white font-bold cursor-pointer">
                                    <flux:modal.trigger name="modal-tiket">
                            ...
                            <tr class="grid grid-cols-14 items-center border-b-2 border-dark">
                                ...
                                <td class="col-span-3 h-full flex justify-center items-center text-center p-2 text-white font-bold border-e-2 border-dark">Rafa Aliftha</td>
                                <td class="col-span-3 h-full flex justify-center items-center text-center p-2 text-white font-bold border-e-2 border-dark">Batam - Bengkalis</td>
                                <td class="col-span-3 h-full flex justify-center items-center text-center p-2 text-white font-bold border-e-2 border-dark">20 Oktober 2023, 08:00 WIB</td>
                                <td class="col-span-2 h-full flex justify-center items-center text-center p-2 text-white font-bold border-e-2 border-dark">Terverfikasi</td>
                                <td class="col-span-2 h-full flex justify-center items-center text-center p-2 text-white font-bold cursor-pointer">
                                    <flux:modal.trigger name="modal-tiket">
                                        <flux:button class="bg-transparent! border-none! text-white! shadow-none! text-xl!">•••</flux:button>
                                    </flux:modal.trigger>
                            ...
                            <tr class="grid grid-cols-14 items-center">
                                ...
                                <td class="col-span-3 h-full flex justify-center items-center text-center p-2 text-white font-bold border-e-2 border-dark">Erlangga Elbrian</td>
                                <td class="col-span-3 h-full flex justify-center items-center text-center p-2 text-white font-bold border-e-2 border-dark">Batam - Tanjung Pinang</td>
                                <td class="col-span-3 h-full flex justify-center items-center text-center p-2 text-white font-bold border-e-2 border-dark">20 Oktober 2023, 08:00 WIB</td>
                                <td class="col-span-2 h-full flex justify-center items-center text-center p-2 text-white font-bold border-e-2 border-dark">Dibatalkan</td>
                                <td class="col-span-2 h-full flex justify-center items-center text-center p-2 text-white font-bold cursor-pointer">
                                    <flux:modal.trigger name="modal-tiket">
                                        <flux:button class="bg-transparent! border-none! text-white! shadow-none! text-xl!">•••</flux:button>
                                    </flux:modal.trigger>                                    
                        ...
                        <tbody class="bg-white rounded-2xl border-2 border-dark flex flex-row justify-between">                            
                            <tr class="flex flex-col items-start w-full">
                                ...
                                <td class="order-last text-start text-sm font-regular flex w-full">
                                    ...
                                    <flux:modal.trigger name="modal-tiket" class="items-start! justify-start! flex! w-full! py-2! px-2! font-bold!">
