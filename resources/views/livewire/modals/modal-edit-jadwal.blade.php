<flux:modal name="modal-edit-jadwal" class="font-sans! min-md:min-w-[calc(100vw*0.75)] max-md:w-[calc(100vw*0.75)] !z-0 overflow-hidden bg-white flex flex-col rounded-2xl! border-2! border-dark! p-0!" tabindex="-1">
