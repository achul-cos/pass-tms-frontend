<div>
    @foreach ($jadwals as $i => $t)
        <flux:modal name="modal-edit-jadwal-{{ $t['id'] }}" class="font-sans! min-md:min-w-[calc(100vw*0.75)] max-md:w-[calc(100vw*0.75)] !z-0 bg-white flex flex-col rounded-2xl! border-2! border-dark! p-0!" tabindex="-1">
            <div class="p-4 bg-yellow text-dark w-full items-center border-b-2 border-dark flex flex-row justify-between">
                <flux:heading class="font-bold! text-xl! font-sans! text-dark! max-w-[calc(100vw*0.6)]">
                    Detail Jadwal - {{ $t['namaJadwal'] ?? ''}} - #{{ $t['id'] ?? '' }}
                </flux:heading>
            </div>
                <div class="p-8 bg-white w-full min-md:pb-12 rounded-b-2xl overflow-y-auto max-h-[calc(100vh*0.7)]">
                    <div class="flex max-md:flex-col min-md:flex-row gap-8 justify-between text-dark fill-dark">
                        <div class="w-full flex flex-col gap-y-4">
                            <div class="min-h-16 w-full flex flex-col gap-2">
                                ...
                                <input
                                    type="text"
                                    class="w-full rounded-r-full bg-dark/10 border-dark/50 border-2 p-1 px-4 outline-none placeholder-black"
                                    placeholder="{{ $t['namaJadwal'] ?? '-' }}"
                                    disabled
                                />
                                </div>
                            </div>                    
                                ...
                                <div class="w-full flex flex-col gap-2">
                                    ...
                                    <div class="relative flex items-stretch">                  
                                        ...
                                        <input
                                            type="text"
                                            name="ruteAsal"
                                            placeholder="{{ $t['lokasiBerangkat'] ?? '-' }}"
                                            class="w-full rounded-r-full bg-dark/10 border-dark/50 border-2 p-1 px-4 pe-8 outline-none placeholder-black"
                                            disabled
                            ...
                            <div class="min-h-16 w-full flex flex-col gap-2">
                                ...
                                <div class="relative flex items-stretch">
                                    ...
                                    <input
                                        id="jumlahPenumpang"
                                        type="text"
                                        class="w-full rounded-r-full bg-dark/10 border-dark/50 border-2 p-1 px-4 outline-none pe-24 focus:ring-2 focus:ring-blue-500 transition placeholder-black"
                                        placeholder="{{ $t['kapasitas'] ?? '-' }}"
                                        disabled
                                    />
                                </div>
                            </div>
                            <div class="min-h-16 w-full flex flex-col gap-2 pt-8">
                                ...
                                <div class="relative flex items-stretch">                  
                                    ...
                                    <input
                                        type="text"
                                        class="w-full rounded-r-full bg-dark/10 border-dark/50 border-2 p-1 px-4 ps-12 outline-none pe-24 placeholder-black"
                                        placeholder="{{ $t['biayaPerjalanan'] ?? '-' }}"
                                        disabled
                                    />
                                </div>
                            </div>                    
                            ...
                            <div class="min-h-16 flex min-lg:flex-row max-lg:flex-col gap-4 justify-between">
                                <div class="w-full flex flex-col gap-2">
                                    ...
                                    <input
                                        type="text"
                                        class="w-full rounded-r-full bg-dark/10 border-dark/50 border-2 p-1 px-4 ps-12 outline-none placeholder-black"
                                        placeholder="{{ $t['biayaMotor'] ?? '-' }}"
                                        disabled
                                    /> 
                                    </div>
                                </div>
                        ...
                        <div class="w-full flex flex-col gap-y-4">
                            <div class="min-h-16 w-full flex flex-col gap-2">
                                ...
                                <div class="relative flex items-stretch">
                                    ...
                                    <input
                                        type="text"
                                        class="w-full rounded-r-full bg-dark/10 border-dark/50 border-2 p-1 px-4 outline-none placeholder-black"
                                        placeholder="{{ $t['tanggalBerangkat'] ?? '-' }}"
                                        disabled
                                    />
                                </div>
                            </div>
                            ...
                            <div class="min-h-16 w-full flex flex-col gap-2">
                                <div class="flex flex-row items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" class="w-6 h-6"><path d="M320 64C461.4 64 576 178.6 576 320C576 461.4 461.4 576 320 576C178.6 576 64 461.4 64 320C64 178.6 178.6 64 320 64zM296 184L296 320C296 328 300 335.5 306.7 340L402.7 404C413.7 411.4 428.6 408.4 436 397.3C443.4 386.2 440.4 371.4 429.3 364L344 307.2L344 184C344 170.7 333.3 160 320 160C306.7 160 296 170.7 296 184z"/></svg>
                                <p class="font-bold">Arrival Threshold</p>
                                </div>
                                <div class="relative flex items-stretch">
                                <div class="w-6 bg-dark/50 rounded-l-full"></div>
                                <input
                                    type="text"
                                    placeholder="{{ $t['arrivalThreshold'] ?? '-' }}"                       
                                    class="w-full rounded-r-full bg-dark/10 border-dark/50 border-2 p-1 px-4 outline-none placeholder-black"
                                    disabled
                                />
                                </div>
                    ...
                    <div class="flex flex-col gap-8 justify-between text-dark fill-dark pt-12">
                        <p class="text-2xl font-bold text-dark">Data Tiket Terjual</p>
                        ...
                        <table class="bg-yellow rounded-2xl border-2 border-dark p-4 flex flex-col gap-y-4 max-lg:hidden ">   
                            <thead>                     
                                <tr class="grid grid-cols-14 gap-x-2">
                                    ...
                                    <th class="col-span-3 w-full rounded-full items-center text-center bg-orange p-2 text-white font-bold border-2 border-dark">Pemesan</th>
                                    <th class="col-span-3 w-full rounded-full items-center text-center bg-orange p-2 text-white font-bold border-2 border-dark">Kontak</th>
                                    <th class="col-span-2 w-full rounded-full items-center text-center bg-orange p-2 text-white font-bold border-2 border-dark">Nomor</th>
                                    <th class="col-span-3 w-full rounded-full items-center text-center bg-orange p-2 text-white font-bold border-2 border-dark">Status</th>
                                    ...
                                    <tr wire:key="desktop-tiket-row-{{ $t['id'] }}"
                                        ...
                                        <td class="col-span-3 h-full flex justify-center items-center text-center p-2 text-black font-bold border-e-2 border-dark">
                                            <div
                                                @class([
                                                    'rounded-full! text-black! border-2! border-dark! p-2 text-center text-base',
                                                    'bg-red-300!'   => ($t['status'] ?? null) === 'dibatalkan',
                                                    'bg-blue-300!'  => ($t['status'] ?? null) === 'menunggu_verifikasi',
                                                    'bg-green-300!' => ($t['status'] ?? null) === 'terverifikasi',
                                                    'bg-white!'     => ! in_array(($t['status'] ?? null), ['dibatalkan','menunggu_verifikasi','terverifikasi'], true),

                                                    'bg-white!' => ! in_array(
                                                        $t['status'] ?? null,
                                                        ['dibatalkan', 'menunggu_verifikasi', 'terverifikasi'],
                                                        true
                                                    ),
                                                ])
                                            >
                                                {{ match ($t['status'] ?? null) {
                                                    ...
                                                    'menunggu_verifikasi' => 'Menunggu Terverifikasi',
                        ...
                        <table class="min-lg:hidden bg-yellow rounded-xl border-2 border-dark p-4 flex flex-col gap-y-2">
                            @if (!empty($t['penumpang']))
                                @foreach ($t['penumpang'] as $i => $m)
                                    <tbody class="bg-white rounded-2xl border-2 border-dark flex flex-row justify-between" wire:key="mobile-tiket-row-{{ $m['id'] }}">                            
                                        <tr class="flex flex-col items-start w-full">
                                            ...
                                            <td class="order-5 text-start text-sm font-regular border-b-1 border-black flex w-full bg-dark/20">
                                                ...
                                                <div class="items-start justify-start flex w-full p-1.25 px-2 font-bold">
                                                    <div
                                                        @class([
                                                            'rounded-full! text-black! border-2! border-dark! p-2 text-center text-base',
                                                            'bg-red-300!'   => ($m['status'] ?? null) === 'dibatalkan',
                                                            'bg-blue-300!'  => ($m['status'] ?? null) === 'menunggu_verifikasi',
                                                            'bg-green-300!' => ($m['status'] ?? null) === 'terverifikasi',
                                                            'bg-white!'     => ! in_array(($m['status'] ?? null), ['dibatalkan','menunggu_verifikasi','terverifikasi'], true),
                                            ...
                                            <td class="order-last text-start text-sm font-regular flex w-full">
                                                ...
                                                <flux:modal.trigger name="modal-tiket-{{ $m['id'] }}" class="items-start! justify-start! flex! w-full! py-2! px-2! font-bold!">
